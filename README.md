...
## Algorithm
1.Import libraries – Import NumPy, Pandas, and Scikit-learn. 
2.Load dataset – Load the Iris dataset and split features and target. 
3.Train model – Train the model using Scikit-learn SGDClassifier. 
4.Predict species – Use the trained model to predict the Iris flower species. 
...
## Output:
<img width="742" height="421" alt="image" src="https://github.com/user-attachments/assets/69cf3da9-1bd2-4486-b9f0-5a4f4b506b81" />
